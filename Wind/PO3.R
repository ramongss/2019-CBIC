PO3<-function(Obs,Pred1,Pred2,Pred3,Pred4,nameM1,nameM2,nameM3,nameM4)
{
  data1<-data.frame(rep(c(nameM1,nameM2,nameM3,nameM4), each = dim(Obs)[1]),
                    rep(Obs),
                    as.vector(unlist(data.frame(Pred1,Pred2,Pred3,Pred4))),
                    rep(c("Training","Test"), 
